...
@section('content')
    <div class="container-fluid mt-4">
        <a href="{{ route('admin.account.create.nhanvienhetong') }}" class="btn btn-primary mb-3">Thêm tài khoản</a>
                ...
                @foreach ($accounts as $account)
                    ...
                    <tr id="{{ $account->User_id }}">
                        ...
                        <td class="d-flex align-items-center">
                            <a href="{{ route('admin.account.edit.nhanvienhetong', ['id' => $account->User_id]) }}"
